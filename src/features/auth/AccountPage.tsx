...
export default function AccountPage() {
    ...
    const { register, handleSubmit, reset, setError, getValues, watch, trigger, formState: { isSubmitting, isValid, isDirty, errors } }
        ...
        <Segment>
            ...
            {currentUser?.providerId === 'github.com' &&
                ...
                <div>
                    ...
                    <p>Please visit Github to update your account setting</p>
