...
import { Button, Form, Header, Segment, SegmentInline } from "semantic-ui-react";
...
export default function EventForm() {
    ...
    async function handleCancelToogle(event: AppEvent) {
                ...
                <SegmentInline >
                    {event && (
                        <Button
                            ...
                            onClick={() => handleCancelToogle(event)}
